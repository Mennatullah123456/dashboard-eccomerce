var form = `<div>
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="write product name">
  </div>
...
function table() {
  ...
  <thead>
    <tr>
      ...
      <th clsaa="col-3">Product name</th>
...
function save() {
    ...
    let email = document.getElementById("price");
...
function edit(index) {
  ...
  <div class="form-group">
    ...
    <input type="text" value="${details[index].name}" class="form-control" id="newName" aria-describedby="emailHelp" placeholder="Update  Name">
  </div>
  <div class="form-group mt-3">
    <label for="price">Price</label>
    <input type="price" value="${details[index].price}" class="form-control" id="newProduct" placeholder="Update  price">
  </div>
